...
class FCN8(nn.Module):
    def __init__(self, n_class=2, with_affinity=False, with_affinity_average=False, shared=False, exp_dict=None):
    ...
    def forward(self, x, return_cam=False, crf=False):
        ...
        h = self.upscore8(h)
        logits = h[:, :, 31:31 + x.size()[2], 31:31 + x.size()[3]].contiguous()
